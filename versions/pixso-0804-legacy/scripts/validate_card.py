...
def main() -> int:
    ...
    parser.add_argument("--capabilities-dir", help="Path to an external capability manifest directory, used to resolve effective data, event, and asset capabilities.")
