...
数据、事件与素材的机器可读真相源由 `scripts/rules/config/capabilities.json` 指向；`reference/capability/` 与 `reference/design/asset-library.md` 是据此生成的检索文档。
...
- `design/asset-library.md`：由远程 asset capability manifest 生成的本地资源清单与语义说明。
