...
- 支持当前 `app-11.7.5.205_rom-6.0` 清单中的天气、日程、倒计时、应用时长、耳机、手机电量和健康运动数据能力。
...
能力清单同步自 CreateMyCard 提交 `854956d` 的 `app-11.7.5.205_rom-6.0`：7 个数据能力、18 个事件能力、72 个素材能力。原始 manifest 位于 `scripts/rules/capabilities/`，校验器直接读取，不再维护手写能力小样本。
